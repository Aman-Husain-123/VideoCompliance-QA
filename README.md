...
4. **Robust Error Handling:** The graph handles "No Transcript" scenarios cleanly, halting gracefully without wasting compute or producing false passes. 
